...
| scasb | 1. scan string <br> 2. al或ax减去di地址内容，等于零ZF = 1，不等于零ZF = 0 <br> 3. al或ax - (di) | di <- di+1 | di <- di-1 |
| scasw | 1. scan string <br> 2. al或ax减去di地址内容，等于零ZF = 1，不等于零ZF = 0 <br> 3. al或ax - (di) | di <- di+2 | di <- di-2 |
