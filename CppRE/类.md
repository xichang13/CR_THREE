...
类型信息：
``` masm
.data:00403068 ; public class HumanPlayer /* mdisp:0 */ : ; IDA解析的继承信息
.data:00403068 ;   public class Player /* mdisp:0 */      ; 基类
.data:00403068 ; class HumanPlayer `RTTI Type Descriptor'
.data:00403068 ??_R0?AVHumanPlayer@@@8 dd offset ??_7type_info@@6B@
.data:00403068                                         ; reference to RTTI's vftable
.data:0040306C                 dd 0                    ; internal runtime reference
.data:00403070 aAvhumanplayer  db '.?AVHumanPlayer@@',0 ; type descriptor name
```
...
基类数组：
``` masm
.rdata:004023C8 ; HumanPlayer::`RTTI Base Class Array'
.rdata:004023C8 ??_R2HumanPlayer@@8 dd offset ??_R1A@?0A@EA@HumanPlayer@@8 ; reference to base class decription 1
.rdata:004023CC                     dd offset ??_R1A@?0A@EA@Player@@8 ; reference to base class decription 2
```
